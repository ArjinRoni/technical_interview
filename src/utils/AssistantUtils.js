...
const instructions = `
    ...
    3. Once you receive the classification token, proceed to trigger the training API with the provided classification token. Inform the user that they should now upload relevant images for their product.
